			...
			if (!window.mode.isMobile()) {
				statusbar.insert('left', [
					...
					{type: 'break', id: 'break9', mobile: false},
					{
						...
						(isReadOnly
							? ' status-readonly-mode" title="' + _('Permission Mode') + '" style="padding: 5px 5px;"> Read-only mode </div>'
							: ' status-edit-mode" title="' + _('Permission Mode') + '" style="padding: 5px 5px;"> Edit mode </div>')
					}
				]);
			}
			break;
